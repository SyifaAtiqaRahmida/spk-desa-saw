  ...
  <div class="main">
    ...
    <main class="content">
      <div class="breadcrumb">
        ...
        <span class="breadcrumb-active">Kelola User</span>
      </div>
      <div class="page-header">
        <div><div class="page-title">Kelola User Admin</div><div class="page-sub">Kelola akun yang bisa mengakses sistem ini</div></div>
        <a href="tambah_user.php" class="btn btn-primary">+ Tambah User</a>
      </div>
      <?php if (isset($_GET['pesan'])): ?>
        <?php if ($_GET['pesan'] == 'tambah'): ?><div class="alert alert-success">User berhasil ditambahkan.</div>
        <?php elseif ($_GET['pesan'] == 'edit'): ?><div class="alert alert-success">User berhasil diperbarui.</div>
        <?php elseif ($_GET['pesan'] == 'hapus'): ?><div class="alert alert-danger">User berhasil dihapus.</div>
        <?php endif; ?>
      <?php endif; ?>
      <div class="card">
        <div class="card-head">
          <div class="card-head-title">Daftar User</div>
          <span class="badge badge-green"><?php echo mysqli_num_rows($query); ?> User</span>
        </div>
          ...
          <table>
            ...
            <tbody>
              <?php if (mysqli_num_rows($query) == 0): ?>
                <tr><td colspan="4"><div class="empty-state"><div class="empty-state-icon">&#128100;</div><div class="empty-state-title">Belum ada user</div></div></td></tr>
              <?php else: ?>
                ...
                <tr>
                  ...
                  <td style="font-weight:500">
                    <div class="d-flex align-center gap-1">
                      <div class="avatar" style="width:28px;height:28px;font-size:11px;"><?php echo strtoupper(substr($row['nama'],0,1)); ?></div>
                  ...
                  <td>
                    <div class="d-flex gap-1 justify-center">
                      <a href="edit_user.php?id=<?php echo $row['id_user']; ?>" class="btn btn-outline btn-sm">Edit</a>
                      <?php if ($row['id_user'] != $_SESSION['user']): ?>
                        <a href="hapus_user.php?id=<?php echo $row['id_user']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus user ini?')">Hapus</a>
                      <?php else: ?>
                        <span class="badge badge-green">Akun Kamu</span>
                      <?php endif; ?>
                    </div>
                  </td>
                </tr>
